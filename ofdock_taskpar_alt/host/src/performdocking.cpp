...
*/
	...
	dockpars.tournament_rate = 100*mypars->tournament_rate;
...
*/
	...
	//setKernelArg(kernel3,4, sizeof(unsigned char),                          &dockpars.gridsize_z);
	//setKernelArg(kernel3,5, sizeof(unsigned char),                          &dockpars.g1);
	//setKernelArg(kernel3,6, sizeof(unsigned int),                           &dockpars.g2);
	//setKernelArg(kernel3,7, sizeof(unsigned int),                           &dockpars.g3);
	//setKernelArg(kernel3,8, sizeof(unsigned char),                          &dockpars.num_of_atoms);
	...
	//setKernelArg(kernel4,3, sizeof(float),		                        &dockpars.coeff_elec);
	//setKernelArg(kernel4,4, sizeof(float),		                        &dockpars.qasp);
	//setKernelArg(kernel4,5, sizeof(float),		                        &dockpars.coeff_desolv);
	//setKernelArg(kernel4,6, sizeof(unsigned int),	                        &dockpars.num_of_intraE_contributors);
	//setKernelArg(kernel4,7, sizeof(float),		                        &dockpars.grid_spacing);
	...
	//setKernelArg(kernel5,2, sizeof(unsigned int),               		&dockpars.pop_size);
	...
	//setKernelArg(kernel7,5, sizeof(unsigned int),               		&dockpars.pop_size);
	//setKernelArg(kernel7,6, sizeof(float),       	        		&dockpars.tournament_rate);
	//setKernelArg(kernel7,7, sizeof(float),       	        		&dockpars.crossover_rate);
	//setKernelArg(kernel7,8, sizeof(float),       	        		&dockpars.mutation_rate);
	//setKernelArg(kernel7,9, sizeof(float),       	        		&dockpars.abs_max_dmov);
	//setKernelArg(kernel7,10,sizeof(float),       	        		&dockpars.abs_max_dang);
	...
	//setKernelArg(kernel8,3, sizeof(unsigned int),                          	&dockpars.num_of_lsentities);
	//setKernelArg(kernel8,4, sizeof(unsigned int),                          	&dockpars.pop_size);
	//setKernelArg(kernel8,5, sizeof(unsigned int),                          	&dockpars.max_num_of_iters);
	//setKernelArg(kernel8,6, sizeof(float),                          	&dockpars.rho_lower_bound);
	//setKernelArg(kernel8,7, sizeof(float),                          	&dockpars.base_dmov_mul_sqrt3);
	//setKernelArg(kernel8,8, sizeof(unsigned int),                          	&dockpars.num_of_genes);
	//setKernelArg(kernel8,9, sizeof(float),                          	&dockpars.base_dang_mul_sqrt3);
	//setKernelArg(kernel8,10,sizeof(unsigned int),                          	&dockpars.cons_limit);
