...
*/
	...
	//setKernelArg(kernel1,5, sizeof(mem_evals_performed),                    &mem_evals_performed);
        //setKernelArg(kernel1,6, sizeof(mem_generations_performed),              &mem_generations_performed);
	...
	//setKernelArg(kernel5,6, sizeof(cl_mem),                          	&mem_KerConst);
        ...
        //setKernelArg(kernel6,1, sizeof(mem_dockpars_energies_current),          &mem_dockpars_energies_current);
        //setKernelArg(kernel6,2, sizeof(mem_dockpars_conformations_next),        &mem_dockpars_conformations_next);
        //setKernelArg(kernel6,3, sizeof(mem_dockpars_energies_next),             &mem_dockpars_energies_next);
        //setKernelArg(kernel6,4, sizeof(mem_dockpars_prng_states),               &mem_dockpars_prng_states);
	//setKernelArg(kernel6,5, sizeof(cl_mem),                          	&mem_KerConst);
        setKernelArg(kernel6,1, sizeof(cl_mem),                          	&mem_DockparametersConst);
	//setKernelArg(kernel6,7, sizeof(mem_evals_performed),                    &mem_evals_performed);
        //setKernelArg(kernel6,8, sizeof(mem_generations_performed),              &mem_generations_performed);
	...
	//setKernelArg(kernel7,5, sizeof(cl_mem),                          	&mem_KerConst);
        setKernelArg(kernel7,5, sizeof(cl_mem),                          	&mem_DockparametersConst);
	//setKernelArg(kernel7,7, sizeof(mem_evals_performed),                    &mem_evals_performed);
        //setKernelArg(kernel7,8, sizeof(mem_generations_performed),              &mem_generations_performed);
        ...
        //setKernelArg(kernel8,2, sizeof(mem_dockpars_conformations_next),        &mem_dockpars_conformations_next);
        //setKernelArg(kernel8,3, sizeof(mem_dockpars_energies_next),             &mem_dockpars_energies_next);
        setKernelArg(kernel8,2, sizeof(mem_dockpars_prng_states),               &mem_dockpars_prng_states);
	//setKernelArg(kernel8,5, sizeof(cl_mem),                          	&mem_KerConst);
        setKernelArg(kernel8,3, sizeof(cl_mem),                          	&mem_DockparametersConst);
	//setKernelArg(kernel8,7, sizeof(mem_evals_performed),                    &mem_evals_performed);
        //setKernelArg(kernel8,8, sizeof(mem_generations_performed),              &mem_generations_performed);
