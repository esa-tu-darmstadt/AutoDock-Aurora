...
//channel char chan_GA2Conf_mode;
//channel char chan_GA2Store_mode;

channel char  chan_IC2Conf_active;	// active 1: receiving Kernel is active, 0 receiving Kernel is disabled
channel char  chan_IC2Conf_mode;	// mode 1 or I: init calculation energy, 2 or G: genetic generation, 3 or P: local search
...
channel char  chan_GG2Conf_active;	// active 1: receiving Kernel is active, 0 receiving Kernel is disabled
channel char  chan_GG2Conf_mode;	// mode 1 or I: init calculation energy, 2 or G: genetic generation, 3 or P: local search
//channel uint  chan_GG2Conf_cnt;		// population count
channel ushort chan_GG2Conf_cnt;		// population count
channel float  chan_GG2Conf_genotype __attribute__((depth(38)));

channel char  chan_LS2Conf_active;	// active 1: receiving Kernel is active, 0 receiving Kernel is disabled
channel char  chan_LS2Conf_mode;	// mode 1 or I: init calculation energy, 2 or G: genetic generation, 3 or P: local search
//channel uint  chan_LS2Conf_cnt;		// population count
channel ushort chan_LS2Conf_cnt;		// population count
