...
set_false_path -from board_inst|acl_ddr4_a10|ddr4_calibrate|sw_reset_n_out -to *
...
set_false_path -from * -to freeze_wrapper_inst|kernel_system_inst|*|*|kernel|twoXclock_consumer_NO_SHIFT_REG
