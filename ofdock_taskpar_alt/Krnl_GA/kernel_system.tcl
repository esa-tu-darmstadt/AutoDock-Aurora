...
add_instance Krnl_GA_system Krnl_GA_system

add_connection clk_1x.out_clk Krnl_GA_system.clock_reset
add_connection clk_2x.out_clk Krnl_GA_system.clock_reset2x
add_connection reset.out_reset Krnl_GA_system.clock_reset_reset
...
add_connection Krnl_GA_system.avm_memgmem0_DDR_port_0_0_rw kernel_mem0.s0
...
add_connection kernel_irq.receiver_irq Krnl_GA_system.kernel_irq
...
set_instance_parameter_value cra_ring_rom ID_W 3
...
add_instance avs_Krnl_Conform_cra_cra_ring cra_ring_node
set_instance_parameter_value avs_Krnl_Conform_cra_cra_ring DATA_W 64
set_instance_parameter_value avs_Krnl_Conform_cra_cra_ring RING_ADDR_W 5
set_instance_parameter_value avs_Krnl_Conform_cra_cra_ring CRA_ADDR_W 4
set_instance_parameter_value avs_Krnl_Conform_cra_cra_ring ID_W 3
set_instance_parameter_value avs_Krnl_Conform_cra_cra_ring ID 0
add_connection clk_1x.out_clk avs_Krnl_Conform_cra_cra_ring.clock
add_connection reset.out_reset avs_Krnl_Conform_cra_cra_ring.reset
add_connection cra_ring_rom.ring_out avs_Krnl_Conform_cra_cra_ring.ring_in
add_connection avs_Krnl_Conform_cra_cra_ring.cra_master Krnl_GA_system.avs_Krnl_Conform_cra
set_connection_parameter_value avs_Krnl_Conform_cra_cra_ring.cra_master/Krnl_GA_system.avs_Krnl_Conform_cra baseAddress "0x0"
add_instance avs_Krnl_GA_cra_cra_ring cra_ring_node
set_instance_parameter_value avs_Krnl_GA_cra_cra_ring DATA_W 64
set_instance_parameter_value avs_Krnl_GA_cra_cra_ring RING_ADDR_W 5
set_instance_parameter_value avs_Krnl_GA_cra_cra_ring CRA_ADDR_W 5
set_instance_parameter_value avs_Krnl_GA_cra_cra_ring ID_W 3
set_instance_parameter_value avs_Krnl_GA_cra_cra_ring ID 1
add_connection clk_1x.out_clk avs_Krnl_GA_cra_cra_ring.clock
add_connection reset.out_reset avs_Krnl_GA_cra_cra_ring.reset
add_connection avs_Krnl_Conform_cra_cra_ring.ring_out avs_Krnl_GA_cra_cra_ring.ring_in
add_connection avs_Krnl_GA_cra_cra_ring.cra_master Krnl_GA_system.avs_Krnl_GA_cra
set_connection_parameter_value avs_Krnl_GA_cra_cra_ring.cra_master/Krnl_GA_system.avs_Krnl_GA_cra baseAddress "0x0"
add_instance avs_Krnl_InterE_cra_cra_ring cra_ring_node
set_instance_parameter_value avs_Krnl_InterE_cra_cra_ring DATA_W 64
set_instance_parameter_value avs_Krnl_InterE_cra_cra_ring RING_ADDR_W 5
set_instance_parameter_value avs_Krnl_InterE_cra_cra_ring CRA_ADDR_W 5
set_instance_parameter_value avs_Krnl_InterE_cra_cra_ring ID_W 3
set_instance_parameter_value avs_Krnl_InterE_cra_cra_ring ID 2
add_connection clk_1x.out_clk avs_Krnl_InterE_cra_cra_ring.clock
add_connection reset.out_reset avs_Krnl_InterE_cra_cra_ring.reset
add_connection avs_Krnl_GA_cra_cra_ring.ring_out avs_Krnl_InterE_cra_cra_ring.ring_in
add_connection avs_Krnl_InterE_cra_cra_ring.cra_master Krnl_GA_system.avs_Krnl_InterE_cra
set_connection_parameter_value avs_Krnl_InterE_cra_cra_ring.cra_master/Krnl_GA_system.avs_Krnl_InterE_cra baseAddress "0x0"
add_instance avs_Krnl_IntraE_cra_cra_ring cra_ring_node
set_instance_parameter_value avs_Krnl_IntraE_cra_cra_ring DATA_W 64
set_instance_parameter_value avs_Krnl_IntraE_cra_cra_ring RING_ADDR_W 5
set_instance_parameter_value avs_Krnl_IntraE_cra_cra_ring CRA_ADDR_W 4
set_instance_parameter_value avs_Krnl_IntraE_cra_cra_ring ID_W 3
set_instance_parameter_value avs_Krnl_IntraE_cra_cra_ring ID 3
add_connection clk_1x.out_clk avs_Krnl_IntraE_cra_cra_ring.clock
add_connection reset.out_reset avs_Krnl_IntraE_cra_cra_ring.reset
add_connection avs_Krnl_InterE_cra_cra_ring.ring_out avs_Krnl_IntraE_cra_cra_ring.ring_in
add_connection avs_Krnl_IntraE_cra_cra_ring.cra_master Krnl_GA_system.avs_Krnl_IntraE_cra
set_connection_parameter_value avs_Krnl_IntraE_cra_cra_ring.cra_master/Krnl_GA_system.avs_Krnl_IntraE_cra baseAddress "0x0"
add_instance avs_Krnl_Store_cra_cra_ring cra_ring_node
set_instance_parameter_value avs_Krnl_Store_cra_cra_ring DATA_W 64
set_instance_parameter_value avs_Krnl_Store_cra_cra_ring RING_ADDR_W 5
set_instance_parameter_value avs_Krnl_Store_cra_cra_ring CRA_ADDR_W 4
set_instance_parameter_value avs_Krnl_Store_cra_cra_ring ID_W 3
set_instance_parameter_value avs_Krnl_Store_cra_cra_ring ID 4
add_connection clk_1x.out_clk avs_Krnl_Store_cra_cra_ring.clock
add_connection reset.out_reset avs_Krnl_Store_cra_cra_ring.reset
add_connection avs_Krnl_IntraE_cra_cra_ring.ring_out avs_Krnl_Store_cra_cra_ring.ring_in
add_connection avs_Krnl_Store_cra_cra_ring.cra_master Krnl_GA_system.avs_Krnl_Store_cra
set_connection_parameter_value avs_Krnl_Store_cra_cra_ring.cra_master/Krnl_GA_system.avs_Krnl_Store_cra baseAddress "0x0"
add_connection avs_Krnl_Store_cra_cra_ring.ring_out cra_root.ring_in
...
set_instance_parameter_value sys_description_rom {ADDRESS_WIDTH} {8}
set_instance_parameter_value cra_ring_rom {ROM_W} {8}
