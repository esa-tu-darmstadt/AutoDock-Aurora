...
module acl_fp_mdot2_a10(running_sum, a1, b1, a2, b2, clock, enable, result);
// Latency 6, 2-element vector dot product. Unlike the _dot2_ version, this performs
// a2*b2 - (a1*b1 + running_sum).
...
defparam mac_fp_wys_02.adder_subtract = "true"; 
