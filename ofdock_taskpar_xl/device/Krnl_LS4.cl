...
{
	#if 0
	printf("\nLS4: DockConst_max_num_of_iters: %u\n",   DockConst_max_num_of_iters);
	printf("LS4: DockConst_rho_lower_bound: %f\n",      DockConst_rho_lower_bound);
	printf("LS4: DockConst_base_dmov_mul_sqrt3: %f\n",  DockConst_base_dmov_mul_sqrt3);
	printf("LS4: DockConst_num_of_genes: %u\n",  	    DockConst_num_of_genes);
	printf("LS4: DockConst_base_dang_mul_sqrt3: %f\n",  DockConst_base_dang_mul_sqrt3);
