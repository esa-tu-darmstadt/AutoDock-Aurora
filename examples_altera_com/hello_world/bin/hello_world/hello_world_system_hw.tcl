...
#### Slave interface avs_hello_world_cra
add_interface avs_hello_world_cra avalon end
set_interface_property avs_hello_world_cra ENABLED true
set_interface_property avs_hello_world_cra associatedClock clock_reset
set_interface_property avs_hello_world_cra addressAlignment DYNAMIC
set_interface_property avs_hello_world_cra burstOnBurstBoundariesOnly false
set_interface_property avs_hello_world_cra explicitAddressSpan 0
set_interface_property avs_hello_world_cra holdTime 0
set_interface_property avs_hello_world_cra isMemoryDevice false
set_interface_property avs_hello_world_cra isNonVolatileStorage false
set_interface_property avs_hello_world_cra linewrapBursts false
set_interface_property avs_hello_world_cra maximumPendingReadTransactions 1
set_interface_property avs_hello_world_cra printableDevice false
set_interface_property avs_hello_world_cra readLatency 0
set_interface_property avs_hello_world_cra readWaitTime 0
set_interface_property avs_hello_world_cra setupTime 0
set_interface_property avs_hello_world_cra timingUnits Cycles
set_interface_property avs_hello_world_cra writeWaitTime 0
set_interface_assignment avs_hello_world_cra hls.cosim.name {}
add_interface_port avs_hello_world_cra avs_hello_world_cra_read read input 1
add_interface_port avs_hello_world_cra avs_hello_world_cra_write write input 1
add_interface_port avs_hello_world_cra avs_hello_world_cra_address address input 4
add_interface_port avs_hello_world_cra avs_hello_world_cra_writedata writedata input 64
add_interface_port avs_hello_world_cra avs_hello_world_cra_byteenable byteenable input 8
add_interface_port avs_hello_world_cra avs_hello_world_cra_readdata readdata output 64
add_interface_port avs_hello_world_cra avs_hello_world_cra_readdatavalid readdatavalid output 1
