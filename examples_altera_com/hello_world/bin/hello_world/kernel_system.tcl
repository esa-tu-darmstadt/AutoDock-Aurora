...
add_instance hello_world_system hello_world_system

add_connection clk_1x.out_clk hello_world_system.clock_reset
add_connection clk_2x.out_clk hello_world_system.clock_reset2x
add_connection reset.out_reset hello_world_system.clock_reset_reset
...
add_connection hello_world_system.avm_memgmem0_DDR_port_0_0_rw kernel_mem0.s0
...
add_connection kernel_irq.receiver_irq hello_world_system.kernel_irq
...
set_instance_parameter_value cra_ring_rom RING_ADDR_W 4
set_instance_parameter_value cra_ring_rom ID_W 0
...
add_instance avs_hello_world_cra_cra_ring cra_ring_node
set_instance_parameter_value avs_hello_world_cra_cra_ring DATA_W 64
set_instance_parameter_value avs_hello_world_cra_cra_ring RING_ADDR_W 4
set_instance_parameter_value avs_hello_world_cra_cra_ring CRA_ADDR_W 4
set_instance_parameter_value avs_hello_world_cra_cra_ring ID_W 0
set_instance_parameter_value avs_hello_world_cra_cra_ring ID 0
add_connection clk_1x.out_clk avs_hello_world_cra_cra_ring.clock
add_connection reset.out_reset avs_hello_world_cra_cra_ring.reset
add_connection cra_ring_rom.ring_out avs_hello_world_cra_cra_ring.ring_in
add_connection avs_hello_world_cra_cra_ring.cra_master hello_world_system.avs_hello_world_cra
set_connection_parameter_value avs_hello_world_cra_cra_ring.cra_master/hello_world_system.avs_hello_world_cra baseAddress "0x0"
add_connection avs_hello_world_cra_cra_ring.ring_out cra_root.ring_in
...
set_instance_parameter_value cra_ring_rom {ROM_EXT_W} {1}
set_instance_parameter_value cra_root {ROM_EXT_W} {1}
